...
def get_response(prompt):
    ...
    if "prompt" in prompt.lower(): # system message for prompts
        system_message = "You provide short prompts for an image generation ai. When a message starts with 'prompt', generate a creative and specific prompt for creating an image in 40 words or less. \
                    ...
                    example4 - user: prompt beautiful evil sorceress \
                    Your response: beautiful evil sorceress, intricate, elegant, highly detailed, beautiful face, leather pants, cleavage, standing, black eyes, brunette hair, HDR, realistic, ultra quality, dynamic lighting, Nikon Z9, Canon 5D, masterpiece, aerial shot, octane render, denoise, extremely detailed"
    else:
